...
describe('SearchFilter', () => {
    ...
    function renderComponent(props) {
        subject = shallow(<SearchFilter {...props}></SearchFilter>);
    }

    it('should render SearchFilterItems', () => {
        expect(subject.find('SearchFilterItem').length).toEqual(mockProps.options.length);
    });
